...
static void usage(const char *name){
    ...
    pinfo("Usage : %s <args>\n\n"
            ...
            "\t[-s|--symmetry]  : point symmetry of the circle      <int> [optional, uses 8 by default]\n\n"
...
static void get_point(char p, const char *name, int *slotx, int *sloty, ArgumentList list, char *argv0){
