...
static void parse_shorthand_argument(int argc, char **argv, int i, size_t len,
                                     struct ArgumentArray list) {
...
static void parse_full_argument(int argc, char **argv, int *i, size_t len,
                                struct ArgumentArray list) {
	if(len < 3) {
